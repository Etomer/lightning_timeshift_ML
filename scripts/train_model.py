...
data_path = "data/datasets/moving_dataset_directivity_medium.hdf5"
...
data_module = MovingImpulseResponseDataModule(data_path,sound_dir,batch_size=120, transform=transform, n_mics_per_batch=11)
#-----------------------------------------------
